...
- [ ] Task: Initialize `deno.json` with import maps and task definitions
    - [ ] Sub-task: Create `deno.json` with strict typescript config
    - [ ] Sub-task: Define tasks for `dev`, `test`, `lint`, `fmt`
